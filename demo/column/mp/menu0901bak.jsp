...
<c:if test="${isSD}">	
	...
	<style type="text/css">
	/*底部菜单*/
	div#menu{left:0px;top:405px;}
	/*时间信息*/
	div#time_info{left:540px;top:82px;width:90px;color:white;font-size:14px;}
	</style>
</c:if>
<!-- 如果是高清版 -->
<c:if test="${!isSD}">
	...
	/*时间信息*/
	div#time_info{left:1140px;top:117px;width:120px;color:white;font-size:20px;}
	</style>
</c:if>	
	<script type="text/javascript">
		...
		setTimeout(function(){
			G('ystest1').innerHTML = '总时长：'+ p.Epg.Mp.getMediaDuration();

		},10000);

		var i = 0;
		function ys(){
			G('ystest').innerHTML = i+'当前时间点：'+ p.Epg.Mp.getCurrentPlayTime();
			i++;
			setTimeout("ys()",1000); 
		}
...
<body>
	...
	<div id="ystest" style="position:absolute;left:300px;top:300px;color:blue;" ></div>
	<div id="ystest1" style="position:absolute;left:300px;top:350px;color:blue;" ></div>
