...
<body onunload="Epg.Mp.destroy();">
	...
	var buttons=
	[
		{id:'hidden',name:'',action:'test',focusImage:'${touming}',beforeMove:menuMove}
	];
	...
	epg.key.set(
	{
		KEY_PAGE_UP:'menuWindow.pageUp()',
		KEY_PAGE_DOWN:'menuWindow.pageDown()',
		KEY_PLAY_PAUSE:'menuWindow.playOrPause()',
		KEY_FAST_FORWARD:'menuWindow.fastForward()',
		KEY_FAST_REWIND:'menuWindow.fastRewind()',
		KEY_VOL_UP:'Epg.Mp.volUp()',
		KEY_VOL_DOWN:'Epg.Mp.volDown()',
		KEY_MUTE:'Epg.Mp.toggleMuteFlag()',
		KEY_TRACK:'Epg.Mp.switchAudioChannel()',
		EVENT_MEDIA_END:'menuWindow.afterVideoPlayEnd()',
		EVENT_MEDIA_ERROR:'menuWindow.Epg.tip("视频播放错误!")'
	});
	
	window.onload=function(){
		epg.btn.init(['hidden'],buttons,'',true);
	}	
	
	function menuMove(dir,button){
		menuWindow.Epg.Button.move(dir);
		return false;
	}
	...
	//rtsp = 'http://182.92.245.103/itv/resources/dianjing/lol/tvup/tvup(24)/24.m3u8';
