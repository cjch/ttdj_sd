...
#vedio_0_div{position:absolute;left:300px;top:378px;width:201px;height:143px;}
#vedio_1_div{position:absolute;left:538px;top:378px;width:201px;height:143px;}
#vedio_2_div{position:absolute;left:776px;top:378px;width:201px;height:143px;}
#vedio_3_div{position:absolute;left:1014px;top:378px;width:201px;height:143px;}

#vedio_4_div{position:absolute;left:300px;top:550px;width:201px;height:143px;}
#vedio_5_div{position:absolute;left:538px;top:550px;width:201px;height:143px;}
#vedio_6_div{position:absolute;left:776px;top:550px;width:201px;height:143px;}
#vedio_7_div{position:absolute;left:1014px;top:550px;width:201px;height:143px;}

#vedio_0{position:absolute;left:285px;top:368px;width:230px;height:167px;}
#vedio_1{position:absolute;left:523px;top:368px;width:230px;height:167px;}
#vedio_2{position:absolute;left:761px;top:368px;width:230px;height:167px;}
#vedio_3{position:absolute;left:1000px;top:368px;width:230px;height:167px;}

#vedio_4{position:absolute;left:285px;top:540px;width:230px;height:167px;}
#vedio_5{position:absolute;left:523px;top:540px;width:230px;height:167px;}
#vedio_6{position:absolute;left:761px;top:540px;width:230px;height:167px;}
#vedio_7{position:absolute;left:1000px;top:540px;width:230px;height:167px;}
...
<body>
	...
	<div style="position:absolute;left:0px;top:40px;font-size:33px;line-height:80px;width:205px;text-align:right;">
	<b>${epg.title}</b>
	</div>	
	...
	<div style="position:absolute;top:39px;left:300px;font-size:20px;color:#788195;line-height:40px;text-align:left;">游戏简介</div>

	<!-- 游戏说明 -->
	<div style="position:absolute;top:100px;left:300px;font-size:21px;color:#f0f0f0;line-height:35px;text-align:left;width:770px;height:145px;overflow:hidden;">${epg.intro}</div>
 
	<!-- 收藏按扭 -->
	<c:if test="${isCollected}">
	<div style="position:absolute;top:247px;left:297px;" ><img id="fav" src="${templateImagePath}btn_alsave_nor.png" width="111" height="41" /></div>
	</c:if>
	<c:if test="${!isCollected}">
	<div style="position:absolute;top:247px;left:297px;" ><img id="fav" src="${templateImagePath}btn_save_nor.png" width="111" height="41" /></div>
	</c:if>
