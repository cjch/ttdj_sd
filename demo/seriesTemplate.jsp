...
<body>
	...
	<!-- 小视频 -->
	<div style="position:absolute; left:60px; top:60px; width:550px; height:326px;">
		<iframe id="videoFrame" name="videoFrame" src="${basePath}media_player.jsp?method=playFromProgram&mp=${programId}&programId=${programId}&mode=listRandomForever&dolog=false&display=smallvod&left=60&top=60&width=550&height=326&source=${target}&sourceType=column&metadataType=smallvod" width="1" height="1" bgcolor="transparent" allowtransparency="true" frameborder="0" scrolling="no"></iframe>
	</div>	 	
	...
	<!-- 全屏 -->
	<div style="position:absolute;left:20px;top:29px;" ><img id="fullcreenBig" src="${touming}" width="623px" height="394px" /></div>
